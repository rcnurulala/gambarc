...
if uploaded_file:
        ...
        # ==========================
            ...
            if prediction_raw is not None:
                ...
                prompt = (
                    ...
                    "Berikan interpretasi yang ringkas dan informatif tanpa mengajukan pertanyaan tambahan."
                )
    ...
    with st.spinner("🧠 Menghasilkan interpretasi..."):
        response = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "Kamu adalah AI yang menjelaskan hasil analisis gambar dengan cara alami, edukatif, dan tidak mengajukan pertanyaan balik."},
